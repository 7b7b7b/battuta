...
HARNESS_TEMP=$(mktemp -d "${TMPDIR:-/tmp}/battuta-update-installer-harness.XXXXXX")
...
xcrun --sdk macosx swiftc \
  ...
  SimuBoardMac/Tests/UpdateInstallerCoreHarness.swift \
  -o "$HARNESS_TEMP/update-installer-core-harness"

"$HARNESS_TEMP/update-installer-core-harness"
